...
<?php
  ...
  function echo_grouped_array($this_grouped_array, $filter_name) {
    ...
    if($filter_name == '') {
      ...
      echo 'No filter set. Use names (e.g. hamilton, meltz) or "type=associate" (full, associate, assistant, lecturer, senior, adjunct)'  . "<div style=clear:both></div>";
      $filtering = false;
  ...
  echo "<input type='button' value='CLEAR SEARCH' onclick='location=\"sis_faculty_filter.php\"' />";
  echo "</form>";
