...
<?php
  ...
  // data files in use
  $csv_arts_sis_2023_spring = 'sis_arts_2023_spring.csv';
  $csv_gsas_sis_2023_spring = 'sis_gsas_2023_spring.csv';
  $csv_arts_sis_2022_fall = 'sis_arts_2022_fall.csv';
  $csv_arts_sis_2022_summer = 'sis_arts_2022_summer.csv';
  $csv_arts_sis_2022_spring = 'sis_arts_2022_spring.csv';
  $csv_arts_sis_2021_fall = 'sis_arts_2021_fall.csv';
  $csv_arts_sis_2021_summer = 'sis_arts_2021_summer.csv';
  $csv_arts_sis_2021_spring = 'sis_arts_2021_spring.csv';
  $csv_arts_sis_2020_fall = 'sis_arts_2020_fall.csv';
  $csv_arts_sis_2020_summer = 'sis_arts_2020_summer.csv';
  $csv_arts_sis_2020_spring = 'sis_arts_2020_spring.csv';
  $csv_arts_sis_2019_summer = 'sis_arts_2019_summer.csv';
  $csv_arts_sis_2019_spring = 'sis_arts_2019_spring.csv';
  $csv_arts_sis_2019_fall = 'sis_arts_2019_fall.csv';
  $csv_arts_sis_2018_summer = 'sis_arts_2018_summer.csv';
  $csv_arts_sis_2018_spring = 'sis_arts_2018_spring.csv';
  $csv_arts_sis_2018_fall = 'sis_arts_2018_fall.csv';
  $csv_faculty_data = 'faculty.csv';
  $csv_test_data = 'test_data_2.csv';

  $data_source_files = array(
    //"2023_TEST" => $csv_test_data,
    "2023_ARTS_SPRING" => $csv_arts_sis_2023_spring,
    "2023_GSAS_SPRING" => $csv_gsas_sis_2023_spring,
    "2022_ARTS_FALL" => $csv_arts_sis_2022_fall,
    "2022_ARTS_SUMMER" => $csv_arts_sis_2022_summer,
    "2022_ARTS_SPRING" => $csv_arts_sis_2022_spring,
    "2021_ARTS_FALL" => $csv_arts_sis_2021_fall,
    "2021_ARTS_SUMMER" => $csv_arts_sis_2021_summer,
    "2021_ARTS_SPRING" => $csv_arts_sis_2021_spring,
    "2020_ARTS_FALL" => $csv_arts_sis_2020_fall,
    "2020_ARTS_SUMMER" => $csv_arts_sis_2020_summer,
    "2020_ARTS_SPRING" => $csv_arts_sis_2020_spring,
    "2019_ARTS_SUMMER" => $csv_arts_sis_2019_summer,
    "2019_ARTS_SPRING" => $csv_arts_sis_2019_spring,
    "2019_ARTS_FALL" => $csv_arts_sis_2019_fall,
    "2018_ARTS_SUMMER" => $csv_arts_sis_2018_summer,
    "2018_ARTS_SPRING" => $csv_arts_sis_2018_spring,
    "2018_ARTS_FALL" => $csv_arts_sis_2018_fall,
  );
      ...
      for($i = 0; $i< $faculty_count; $i++) {
        ...
        if($filtering) {
          ...
          foreach($filter_array as $key=>$value) {
            ...
            if($query_searchtype == strtolower($PROGRAM)) {
              $query_programs = $query_values;
              $programsearch = true;
            }
...
*/
          ...
          if($resultmatch) {
            ...
            } elseif($current_faculty_courses[$j][$SUBJECT] == $GSAS) {

              $faculty_column_output .= return_output("<div class='gsas_class'>");
            } else {
